...
const relations = [
  ...
  {
    doc: 'Certificado Examen Práctico',
    acts: [
      'Camión Extracción KOM 830E-1',
      'Buses',
      'Camión Ampliroll',
...
async function main() {
  for (const rel of relations) {
    ...
    for (const actName of rel.acts) {
      ...
      let notes = '';
      if (
        activityDocumentationNotes[actName] &&
        activityDocumentationNotes[actName][rel.doc]
      ) {
