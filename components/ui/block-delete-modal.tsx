                    ...
                    <ModalBody>
                        <div className="space-y-4">
                            <p>
                                ...
                                un usuario asignado que necesita ser reasignado.
                            </p>
                            <div className="border rounded-md p-4">
                                <div className="text-sm">
                                    ...
                                    {assignedUsers[0].company?.name && (
                                        <p className="text-gray-400 text-xs">{assignedUsers[0].company.name}</p>
                                    )}
                                </div>
                            </div>
                        </div>
            ...
            <ModalContent>
                ...
                <ModalBody>
                    <div className="space-y-4">
                        <p>
                            El administrador <span className="font-semibold">{adminName}</span> tiene 
                            {assignedUsers.length} usuarios asignados que necesitan ser reasignados.
                        </p>
