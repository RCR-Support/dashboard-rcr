              ...
              <CommandGroup>
                <div className="flex items-center justify-between">
                  {selectedValues.length > 0 && (
                    <>
                      <CommandItem
                        ...
                        className="flex-1 justify-center cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-900 "
                      >
                        Limpiar
                      </CommandItem>
                      <Separator
                  ...
                  <CommandItem
                    ...
                    className="flex-1 justify-center cursor-pointer max-w-full hover:bg-gray-100 dark:hover:bg-gray-900 "
                  >
                    Cerrar
                  </CommandItem>
                </div>
