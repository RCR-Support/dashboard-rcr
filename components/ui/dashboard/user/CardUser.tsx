                ...
                <div className="space-y-4">
                  <p className="flex justify-start items-center gap-2">
                    ...
                    <span className="truncate text-ellipsis max-w-[360px]">
                      {selectedUser.name} {selectedUser.middleName}{' '}
                  ...
                  <p className="flex justify-start items-center gap-2">
                    ...
                    <span className="truncate text-ellipsis max-w-[360px]">
                      {formatRun(selectedUser.company?.rut || '')}
                    </span>
                  </p>
                  <p>
                    <span className="font-semibold">N° Telefono: </span>{' '}
                    <span className="truncate text-ellipsis max-w-[360px]">
                      {formatPhoneNumber(selectedUser.company?.phone || '')}
                    </span>
                  </p>
                  {selectedUser.adminContractorId && (
                    <>
                      ...
                      <p className="flex justify-start items-center gap-2">
                        <span className="font-semibold">Nombre:</span>{' '}
                        <span className="truncate text-ellipsis max-w-[360px]">
                          {selectedUser.adminContractor?.name}{' '}
                          {selectedUser.adminContractor?.lastName}{' '}
                        </span>
                      </p>
                      <p className="flex justify-start items-center gap-2">
                        <span className="font-semibold">Email:</span>{' '}
                        <span className="truncate text-ellipsis max-w-[360px]">
                          {selectedUser.adminContractor?.email}
                        </span>{' '}
                      </p>
                    </>
                  )}
                        ...
                        {selectedUser.assignedUsers.length === 0 ? (
                          ...
                          <>
                            ...
                            <div className="space-y-2">
                              <h3 className="font-semibold text-sm">
                                Usuarios asignados a este administrador:
                              </h3>
                              ...
                              <p className="text-xs text-amber-500">
                                ...
                                {selectedUser.assignedUsers.length}
                              </p>
                            </div>
                          </>
                        )}
