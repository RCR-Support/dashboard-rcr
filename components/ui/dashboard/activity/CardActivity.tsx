      ...
      <div className="col-span-12">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {sortedActivities.map(activity => (
            <div
              key={activity.id}
              className="bg-white dark:bg-[#282c34] rounded-lg shadow-md hover:shadow-lg transition-shadow overflow-hidden flex flex-col relative h-[260px]"
            >
              <div className="w-full h-48 relative overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-3 z-10">
                  <h3 className="font-semibold mb-2 text-center text-lg truncate max-w-full text-white drop-shadow-md">
                    {activity.name}
                  </h3>
