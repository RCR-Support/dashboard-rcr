    ...
    if (contracts.length === 0) {
        return (
            <div className="text-center py-8 text-slate-500 dark:text-slate-400">
                ...
                {isEditing ? (
                    <p className="text-sm">Utiliza el botón &quot;Agregar Contrato&quot; para comenzar.</p>
                )
                : (
                    <div className="space-y-2 text-slate-500 dark:text-slate-300">
                        <p className="text-sm">
                            Primero debes crear la empresa
                        </p>
                        <p className="text-sm">
    ...
    return (
        <div className="space-y-2 mt-4">
            ...
            {contracts.map((contract) => (
                ...
                >
                    {/* Nombre del Contrato */}
                    <h4 className="font-medium md:font-normal">{contract.contractName}</h4>
                    {/* Número de Contrato */}
