...
import { buildWelcomeEmailHtml } from './account-email-templates';
...
export async function sendWelcomeEmail(params: {
  ...
  await sendEmail(params.toEmail, '¡Bienvenido/a a SHEQ Manto Verde! — Tus credenciales de acceso', html);
}
