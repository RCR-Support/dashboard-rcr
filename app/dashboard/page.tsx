  ...
  return (
    <div className="flex flex-col justify-center items-center text-4xl ">
      <div className="grid grid-cols-12 grid-rows-12 gap-4 w-full lg:max-w-[1280px] h-full ">
        ...
        <div className="col-span-3 row-span-2 col-start-1 row-start-3 card-box">
          2
        </div>
        ...
        <div className="col-span-8 row-span-5 col-start-5 row-start-5 card-box">
          6
        </div>
        <div className="col-span-4 row-span-3 row-start-10 card-box">7</div>
        <div className="col-span-4 row-span-3 col-start-5 row-start-10 card-box">
          8
        </div>
        <div className="col-span-4 row-span-3 col-start-9 row-start-10 card-box">
          9
        </div>
      </div>
    </div>
