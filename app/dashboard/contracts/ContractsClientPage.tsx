...
import { FileText, Search, Calendar, Building2, User, FileCheck } from 'lucide-react';
...
export default function ContractsClientPage({ contracts, canCreate, isAdmin }: Props) {
